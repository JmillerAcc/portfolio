    ...
    <div className='pb-20 pt-36'>
        <div>
            ...
            <div className='flex justify-center relative my-20 z-10 '>
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center text-blue-100'>
                    ...
                    <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-xl '>
                        Hi, I&apos;m Justin, a Next.js Developer based in Henderson, Ky USA.
                    </p>
                    <a href='#about'>
                        <MagicButton
                            title="Show my work"
