  ...
  return (
    <div
      ...
      style={ {
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(59,59,81,1) 26%, rgba(93,108,111,1) 100%)'
      } }
    >
      ...
      <div className="flex gap-1 lg:gap-3 w-fit absolute -right-3 lg:-right-1 lg:top-0 ">
        <div className="flex flex-col gap-3 lg:gap-6 lg:mt-0">
          {['React.js', 'Next.js', '.Net',].map((item) => (
            <span key={item} className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#0c1038]">
              {item}
            </span>
          ))}
          <span className="py-4 px-3 rounded-lg text-center bg-[#0c1038]" />
        </div>
        <div className="flex flex-col gap-3 lg:gap-6">
            <span className="py-4 px-3 rounded-lg text-center bg-[#0c1038]" />
          {['Node.js', 'MSSQL', 'Prisma',].map((item) => (
            <span key={item} className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#0c1038]">
              {item}
            </span>
          ))}
